...
- Review patrol and response coverage using recent accident and dispatch records.
...
- Use crash severity and traffic volumes to prioritise road improvements.
:::
::: {.column width="47%"}
...
Confirm current demand and conditions on site before changing deployments or choosing road treatments.
