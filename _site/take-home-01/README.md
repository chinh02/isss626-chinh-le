# Take-home Exercise 1 — first instalment
...
This instalment covers study design, acquisition, data quality and initial
exploration. KDE, second-order inference, final recommendations and revealjs
slides are intentionally deferred.

## Reproduce from the repository root

Required R packages: sf, tidyverse, spatstat.geom, digest, jsonlite, knitr,
and rmarkdown. The report prints the versions used via sessionInfo().
